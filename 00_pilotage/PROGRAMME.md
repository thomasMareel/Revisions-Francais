# Programme de français-philosophie : concours 2027 (PT*)

> **Rôle de ce fichier** : c'est la référence unique pour tout ce qui est produit dans ce dépôt. Si un document contredit ce fichier, c'est le document qui a tort, ou bien ce fichier doit être corrigé (avec une entrée dans `JOURNAL.md`).
>
> Établi le 24/09/2026 par recherche web. L'accès direct au Bulletin officiel et à banquept.fr était **bloqué par le réseau de la session**. Le contenu ci-dessous est donc **recoupé à partir de plusieurs sources secondaires concordantes** (liste en bas). Les niveaux de confiance sont indiqués.

## 1. Deux thèmes au programme pour le concours 2027

L'arrêté du 22 avril 2026 (BO n° 21 de 2026, référence ESRS2611873A) fixe **deux thèmes** pour l'année 2026-2027 dans toutes les filières scientifiques (MPSI, PCSI, MP2I, PTSI, BCPST, et en 2e année MP, PC, MPI, PSI, PT, BCPST2) :

| # | Thème | Statut | Confiance |
|---|-------|--------|-----------|
| 1 | **Expériences de la nature** | reconduit : déjà au programme en 2025-2026, donc étudié en PTSI l'an dernier | élevée |
| 2 | **Les arcanes de la création** | nouveau en 2026-2027 | élevée |

> ⚠️ **À confirmer auprès de ton professeur** : comment les deux thèmes se répartissent pour l'épreuve Banque PT 2027 (sujet sur l'un ou l'autre thème ? tirage ?) et quel thème est traité en cours cette année. Voir `DECISIONS.md`.

## 2. Les œuvres

### Thème 1 : « Expériences de la nature » (déjà vu en 1re année)
...
### Thème 2 : « Les arcanes de la création » (nouveau)
...
## 3. L'épreuve : Banque PT, « Français B » (écrit)

| Élément | Ce qu'on sait | Confiance |
|---------|---------------|-----------|
...
Programme :
- Arrêté (non consulté directement : réseau bloqué) : <https://www.education.gouv.fr/bo/2026/Hebdo21/ESRS2611873A> et <https://www.enseignementsup-recherche.gouv.fr/fr/bo/2026/Hebdo21/ESRS2611873A>
- L'Express Éducation, « Thèmes de français-philosophie en prépa scientifique 2027 » : <https://lexpress-education.com/actualites/themes-francais-philosophie-prepa-scientifique-2027/>
- WikiPrépa : <https://wikiprepa.fr/theme-francais-philosophie-prepa-2026-2027/>
- Neoprofs : <https://www.neoprofs.org/t148729-theme-francais-philosophie-2026-2027-cpge-scientifiques>
- L'Éclaireur Fnac : <https://leclaireur.fnac.com/selection/cp70832-prepas-scientifiques-cpge-2026-2027-les-arcanes-de-la-creation-au-programme-francais-et-philo/>
