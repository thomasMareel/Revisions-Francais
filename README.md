...
## Ton paquet Anki (2 min par jour)

Claude rédige et met à jour les cartes ; tu importes **un seul fichier** dans AnkiDroid : [`exports/anki/francais-PT.apkg`](exports/anki/francais-PT.apkg). Mode d'emploi (installation, réglages, mises à jour) : [`exports/anki/README.md`](exports/anki/README.md). Ton plan complet, calé sur tes 15 min par semaine : [`00_pilotage/FEUILLE_DE_ROUTE.md`, § 0](00_pilotage/FEUILLE_DE_ROUTE.md).
...
| P2 | 59 flashcards : Platon, *Ion* et *République* X | [Markdown](echantillons/02_flashcards_Platon_Ion-Republique-X.md) | [Paquet Anki d'essai `.apkg`](exports/anki/echantillons/02_flashcards_Platon_Ion-Republique-X.apkg) · [PDF](exports/pdf/echantillons/02_flashcards_Platon_Ion-Republique-X.pdf) · [`.tsv`](echantillons/02_flashcards_Platon_Ion-Republique-X.tsv) |
